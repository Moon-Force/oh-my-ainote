...
- Use Kotlin, Jetpack Compose, and AndroidX Ink 1.0.0. Do not introduce Flutter.
...
- Do not add iText, Room as the notebook source of truth, EncryptedSharedPreferences, OEM pen SDKs, or Ink 1.1 alpha APIs.
